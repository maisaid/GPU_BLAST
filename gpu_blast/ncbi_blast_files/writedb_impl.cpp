/*  $Id: writedb_impl.cpp 177347 2009-11-30 18:43:57Z maning $
 * ===========================================================================
 *
...
static char const rcsid[] = "$Id: writedb_impl.cpp 177347 2009-11-30 18:43:57Z maning $";
...
/* ********** FINISH ************* */
    : m_Dbname           (dbname),
      ...
      m_SortSequences    (sort_sequences)
      /* ********** FINISH ************* */
{
...
/* *********** START ************* */
      if( m_SortSequences ) {
	done = m_Volume->WriteSequenceSort(m_Sequence,
					   m_Ambig,
					   m_BinHdr,
					   m_Ids,
					   m_Pig,
