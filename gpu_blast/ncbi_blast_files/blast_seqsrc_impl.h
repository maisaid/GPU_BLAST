/*  $Id: blast_seqsrc_impl.h 161402 2009-05-27 17:35:47Z camacho $
 * ===========================================================================
 *
...
/** Function pointer typedef to set a Boolean. */
typedef void (*SetBoolFnPtr)
    (void* seqsrc_impl, /**< BlastSeqSrc implementation's data structure */
     Boolean arg);
...
DECLARE_BLAST_SEQ_SRC_MEMBER_FUNCTIONS(ResetChunkIteratorFnPtr,
                                       ResetChunkIterator);
/* *********** START ************* */
DECLARE_BLAST_SEQ_SRC_MEMBER_FUNCTIONS(SetInt4FnPtr,
				       SetChunkIterator);
DECLARE_BLAST_SEQ_SRC_MEMBER_FUNCTIONS(SetBoolFnPtr,
				       SetMmapMemory);
