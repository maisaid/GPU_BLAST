...
/*  $Id: writedb_volume.hpp 184161 2010-02-25 13:17:22Z maning $
 * ===========================================================================
 *
...
/* *********** START ************* */
//Class used to store the sequences, the headers, and the length of the sequences
//in order to sort them
class bioseq_class{                                                                                                                                           
                                                                                                                                                              
public:                                                                                                                                                       
  bioseq_class( string  seq_in,                                                                                                                             
		string  binhdr_in,                                                                                                                          
                  int length_in                                                                                                                               
		)                                                                                                                                           
  {                                                                                                                                                     
...
public:
    ...
    /* *********** START ************* */
    static void x_ExtractDeflines(CConstRef<CBlast_def_line_set> & deflines,                                                                                  
				  string                         & bin_hdr,                                                                                   
				  int                              OID=-1);                                                                                   
  ...
  /* *********** START ************* */
  bool WriteSequenceSort(const string    & seq,                                                                                                             
			 const string    & ambig,                                                                                                           
			 const string    & binhdr,                                                                                                          
			 const TIdList   & ids,                                                                                                             
			 int               pig,                                                                                                             
...
private:
    ...
    /* *********** START ************* */
    int              m_HdrDataSizeInitial;                                                                                                                    
    int              m_IdxDataSizeInitial;                                                                                                                    
    int              m_SeqOffsetInitial;                                                                                                                      
    int              m_SeqLettersInitial;                                                                                                                     
    int              m_OIDInitial;       
    
    std::vector < bioseq_class > bioseq_vector;                                                                                                               
    bool             m_LastSequence;                                                                                                                          
