/*  $id: bl2seq.cpp 161402 2009-05-27 17:35:47Z camacho $
 * ===========================================================================
 *
...
/* *********** START ************* */
    ...
    m_GpuOpts = (BlastGPUOptions*)malloc(sizeof(BlastGPUOptions));
    m_GpuOpts->use_gpu          = (char)kOptions.GetUseGpu();
    m_GpuOpts->num_threadsx     = kOptions.GetNumGpuThreads();
    m_GpuOpts->num_blocksx      = kOptions.GetNumGpuBlocks();
    m_GpuOpts->num_sequences_to = kOptions.GetNumGpuSequences();
    m_GpuOpts->method           = kOptions.GetGpuMethod();
    m_GpuOpts->cpu_threads      = kOptions.GetNumCpuThreads();
