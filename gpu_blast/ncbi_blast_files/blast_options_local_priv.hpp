...
/* *********** START ************* */
   ...
   /******************** GPU options *******************/
    ...
    int GetNumGpuThreads() const;
    int GetNumGpuBlocks() const;
    int GetNumGpuSequences() const;
    int GetGpuMethod() const;
    int GetNumCpuThreads() const;

    void SetUseGpu( bool use_gpu );
    void SetNumGpuThreads( int gpu_threads);
    void SetNumGpuBlocks( int gpu_blocks );
    void SetNumGpuSequences( int gpu_num_sequences );
    void SetGpuMethod( int gpu_method );
    void SetNumCpuThreads( int cpu_threads );
...
inline int CBlastOptionsLocal::GetNumGpuThreads() const
{
  return m_NumGpuThreads;
}

inline int CBlastOptionsLocal::GetNumGpuBlocks() const
{
  return m_NumGpuBlocks;
}

inline int CBlastOptionsLocal::GetNumGpuSequences() const
{
  return m_NumGpuSequences;
}

inline int CBlastOptionsLocal::GetGpuMethod() const
{
  return m_GpuMethod;
}

inline int CBlastOptionsLocal::GetNumCpuThreads() const
{
...
inline void CBlastOptionsLocal::SetNumGpuThreads( int num_gpu_threads )
{
  m_NumGpuThreads = num_gpu_threads;
}

inline void CBlastOptionsLocal::SetNumGpuBlocks( int num_gpu_blocks )
{
  m_NumGpuBlocks = num_gpu_blocks;
}

inline void CBlastOptionsLocal::SetNumGpuSequences( int num_sequences )
{
  m_NumGpuSequences = num_sequences;
}

inline void CBlastOptionsLocal::SetGpuMethod( int method )
{
  m_GpuMethod = method;
}

inline void CBlastOptionsLocal::SetNumCpuThreads( int num_cpu_threads )
{
  m_NumCpuThreads = num_cpu_threads;
}
