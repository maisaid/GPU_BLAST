/*  $Id: seqdb.cpp 182018 2010-01-26 13:19:09Z maning $
 * ===========================================================================
 *
...
static char const rcsid[] = "$Id: seqdb.cpp 182018 2010-01-26 13:19:09Z maning $";
...
/* *********** START ************* */
void CSeqDB::SetInternalChunkBookmark(int InternalChunkBookmark )
{
  m_Impl->SetInternalChunkBookmark(InternalChunkBookmark);
}

void CSeqDB::SetMmapMemory(bool MmapMemory )
{
  m_Impl->SetMmapMemory(MmapMemory);
}
