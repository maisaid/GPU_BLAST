...
static char const rcsid[] =
    "$Id: blast_options_cxx.cpp 193174 2010-06-01 19:39:35Z madden $";
...
int CBlastOptions::GetNumGpuThreads() const
{
  if (! m_Local) {
    x_Throwx("Error: GetNumGpuThreads() not available.");
  }

  return m_Local->GetNumGpuThreads();
}

int CBlastOptions::GetNumGpuBlocks() const
{
  if (! m_Local) {
    x_Throwx("Error: GetNumGpuBlocks() not available.");
  }

  return m_Local->GetNumGpuBlocks();
}

int CBlastOptions::GetNumGpuSequences() const
{
  if (! m_Local) {
    x_Throwx("Error: GetNumGpuSequences() not available.");
  }

  return m_Local->GetNumGpuSequences();
}


int CBlastOptions::GetGpuMethod() const
{
  if (! m_Local) {
    x_Throwx("Error: GetGpuMethod() not available.");
  }

  return m_Local->GetGpuMethod();
}

int CBlastOptions::GetNumCpuThreads() const
{
  if (! m_Local) {
    x_Throwx("Error: GetNumCpuThreads() not available.");
  }

  return m_Local->GetNumCpuThreads();
}
...
void CBlastOptions::SetNumGpuThreads( int gpu_num_threads )
{
  if (m_Local) {
    m_Local->SetNumGpuThreads( gpu_num_threads );
  }
  if (m_Remote) {
    //                                                                                              
  }
...
void CBlastOptions::SetNumGpuBlocks( int gpu_num_blocks )
{
  if (m_Local) {
    m_Local->SetNumGpuBlocks( gpu_num_blocks );
  }
  if (m_Remote) {
    //                                                                                              
  }
...
void CBlastOptions::SetNumGpuSequences( int gpu_num_sequences )
{
  if (m_Local) {
    m_Local->SetNumGpuSequences( gpu_num_sequences );
  }
  if (m_Remote) {
    //                                                                                              
  }
...
void CBlastOptions::SetGpuMethod( int gpu_method )
{
  if (m_Local) {
    m_Local->SetGpuMethod( gpu_method );
  }
  if (m_Remote) {
    //                                                                                              
  }
...
void CBlastOptions::SetNumCpuThreads( int cpu_num_threads )
{
  if (m_Local) {
    m_Local->SetNumCpuThreads( cpu_num_threads );
  }
  if (m_Remote) {
    //                                                                                              
  }
