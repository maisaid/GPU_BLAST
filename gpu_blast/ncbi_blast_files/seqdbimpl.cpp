/*  $Id: seqdbimpl.cpp 197051 2010-07-13 12:54:34Z camacho $
 * ===========================================================================
 *
...
static char const rcsid[] = "$Id: seqdbimpl.cpp 197051 2010-07-13 12:54:34Z camacho $";
...
/* *********** START ************* */
void CSeqDBImpl::SetInternalChunkBookmark(int NextChunkOID){
  CHECK_MARKER();
  CFastMutexGuard guard(m_OIDLock);
  m_NextChunkOID = NextChunkOID;
}

void CSeqDBImpl::SetMmapMemory(bool mmap_memory){
  
  m_MmapMemory = mmap_memory;
}
/* ********** FINISH ************* */
